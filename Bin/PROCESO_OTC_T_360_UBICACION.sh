...
$VAL_RUTA_APLICACION --master yarn --executor-memory 2G --num-executors 10 --executor-cores 2 --driver-memory 2G  $VAL_RUTA_PROCESO/$VAL_NOMBRE_PROYECTO/Python/$VAL_NOMBRE_PROCESO.py -rps $VAL_REPROCESO \
...
# sh -x /home/nae108834/Reingenieria_Cliente360/Bin/OTC_T_360_UBICACION.sh 20230105 0