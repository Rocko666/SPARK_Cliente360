...
ENTIDAD=DEC_OTC_T_360_UBICACION
...
TABLA_MKSHAREVOZDATOS_90=`mysql -N  <<<"select valor from params_des where ENTIDAD = '"$ENTIDAD"' AND parametro = 'TABLA_MKSHAREVOZDATOS_90';"` 
