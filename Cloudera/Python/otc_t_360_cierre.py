...
try:
    ...
    print(lne_dvs())
    vTC06=nme_tbl_otc_t_360_cierre_06(vSchTmp)
    vTC07=nme_tbl_otc_t_360_cierre_07(vSchTmp)
    vTC08=nme_tbl_otc_t_360_cierre_08(vSchTmp)
    vTC09=nme_tbl_otc_t_360_cierre_09(vSchTmp)
    vTC10=nme_tbl_otc_t_360_cierre_10(vSchTmp)
    vTC11=nme_tbl_otc_t_360_cierre_11(vSchTmp)
    vTC12=nme_tbl_otc_t_360_cierre_12(vSchTmp)
    vTC13=nme_tbl_otc_t_360_cierre_13(vSchTmp)
    vTC14=nme_tbl_otc_t_360_cierre_14(vSchTmp)
    print(etq_info(log_p_parametros('vTC06',vTC06)))
    print(etq_info(log_p_parametros('vTC07',vTC07)))
    print(etq_info(log_p_parametros('vTC08',vTC08)))
    print(etq_info(log_p_parametros('vTC09',vTC09)))
    print(etq_info(log_p_parametros('vTC10',vTC10)))
    print(etq_info(log_p_parametros('vTC11',vTC11)))
    print(etq_info(log_p_parametros('vTC12',vTC12)))
    print(etq_info(log_p_parametros('vTC13',vTC13)))
    print(etq_info(log_p_parametros('vTC14',vTC14)))
    te_step = datetime.now()
    print(etq_info(msg_d_duracion_ejecucion(VStp,vle_duracion(ts_step,te_step))))
except Exception as e:
    exit(etq_error(msg_e_ejecucion(VStp,str(e))))
