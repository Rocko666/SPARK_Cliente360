...
try:
    ...
    parser.add_argument('--vC_JDBC', required=True, type=str)
    parser.add_argument('--vUser', required=True, type=str)
    ...
    print(etq_info(log_p_parametros("vC_JDBC",vC_JDBC)))
    print(etq_info(log_p_parametros("vUser",vUser)))
...
VStp='Paso [4.1]: Se crea la tabla  {} '.format(nme_tbl_otc_t_360_modelo_01(vMainSchema))
#******************************************************************************************************************************************************************************************************************************************************************************************************#
try:
    ts_step = datetime.now()
    print(etq_info(VStp))
    ...
    if df_01.rdd.isEmpty():
        ...
        try:
            ...
            df_01.write.mode('overwrite').saveAsTable(str(nme_tbl_otc_t_360_modelo_01(vMainSchema)))
            df_01.printSchema()
            ...
            exit(etq_error(msg_e_insert_hive(str(nme_tbl_otc_t_360_modelo_01(vMainSchema)),str(e))))
    te_step = datetime.now()
    print(etq_info(msg_d_duracion_ejecucion(VStp,vle_duracion(ts_step,te_step))))
except Exception as e:
    exit(etq_error(msg_e_ejecucion(VStp,str(e))))
...
VStp='Paso [4.2]: Se crea la tabla  {} '.format(nme_tbl_tmp_otc_t_360_modelo_02(vTempSchema))
#******************************************************************************************************************************************************************************************************************************************************************************************************#
try:
    ts_step = datetime.now()
    print(etq_info(VStp))
    ...
    try:  
        vProcDDL1="beeline -u '{}' -n {} -e \"{}\"".format(vC_JDBC,vUser,drop_tmp(vTempSchema,"tmp_mod_urm_dtacs"))
        print(vProcDDL1)
        output = subprocess.check_output(vProcDDL1 , shell=True)
        
        print(etq_sql(qry_beeline_01(vTUrmDtacs)))
        query = qry_beeline_01(vTUrmDtacs)
        vProcBL="beeline -u '{}' -n {} -e \"{}\"".format(vC_JDBC,vUser,query)
        print(vProcBL)
        output = subprocess.check_output(vProcBL , shell=True)
    except Exception as e:
        exit(etq_error(msg_e_ejecucion("Error al copiar tabla temporal "+vTUrmDtacs,str(e))))
        
    del query
    print(etq_sql(qry_otc_t_360_modelo_02(vTUrmDtacs)))
    df_02=spark.sql(qry_otc_t_360_modelo_02(vTUrmDtacs))
    if df_02.rdd.isEmpty():
        ...
        try:
            ...
            df_02.write.mode('overwrite').saveAsTable(str(nme_tbl_tmp_otc_t_360_modelo_02(vTempSchema)))
            df_02.printSchema()
            ...
            exit(etq_error(msg_e_insert_hive(str(nme_tbl_tmp_otc_t_360_modelo_02(vTempSchema)),str(e))))
    te_step = datetime.now()
    print(etq_info(msg_d_duracion_ejecucion(VStp,vle_duracion(ts_step,te_step))))
except Exception as e:
    exit(etq_error(msg_e_ejecucion(VStp,str(e))))
...
VStp='Paso [4.3]: Se crea la tabla  {} '.format(nme_tbl_otc_t_360_modelo_03(vMainSchema))
#******************************************************************************************************************************************************************************************************************************************************************************************************#
try:
    ts_step = datetime.now()
    print(etq_info(VStp))
    ...
    if df_03.rdd.isEmpty():
        ...
        try:
            ...
            df_03.write.mode('overwrite').saveAsTable(str(nme_tbl_otc_t_360_modelo_03(vMainSchema)))
            df_03.printSchema()
            ...
            exit(etq_error(msg_e_insert_hive(str(nme_tbl_otc_t_360_modelo_03(vMainSchema)),str(e))))
    te_step = datetime.now()
    print(etq_info(msg_d_duracion_ejecucion(VStp,vle_duracion(ts_step,te_step))))
except Exception as e:
    exit(etq_error(msg_e_ejecucion(VStp,str(e))))
...
VStp='Paso [4.4]: Se crea la tabla  {} '.format(nme_tbl_otc_t_360_modelo_04(vMainSchema))
#******************************************************************************************************************************************************************************************************************************************************************************************************#
try:
    ts_step = datetime.now()
    print(etq_info(VStp))
    ...
    if df_04.rdd.isEmpty():
        ...
        try:
            ...
            df_04.write.mode('overwrite').saveAsTable(str(nme_tbl_otc_t_360_modelo_04(vMainSchema)))
            df_04.printSchema()
            ...
            exit(etq_error(msg_e_insert_hive(str(nme_tbl_otc_t_360_modelo_04(vMainSchema)),str(e))))
    te_step = datetime.now()
    print(etq_info(msg_d_duracion_ejecucion(VStp,vle_duracion(ts_step,te_step))))
except Exception as e:
    exit(etq_error(msg_e_ejecucion(VStp,str(e))))
...
VStp='Paso [4.5]: Se crea la tabla  {} '.format(nme_tbl_tmp_otc_t_360_modelo_05(vTempSchema))
#******************************************************************************************************************************************************************************************************************************************************************************************************#
try:
    ts_step = datetime.now()
    print(etq_info(VStp))
    ...
    if df_05.rdd.isEmpty():
        ...
        try:
            ...
            df_05.write.mode('overwrite').saveAsTable(str(nme_tbl_tmp_otc_t_360_modelo_05(vTempSchema)))
            df_05.printSchema()
            ...
            exit(etq_error(msg_e_insert_hive(str(nme_tbl_tmp_otc_t_360_modelo_05(vTempSchema)),str(e))))
    te_step = datetime.now()
    print(etq_info(msg_d_duracion_ejecucion(VStp,vle_duracion(ts_step,te_step))))
except Exception as e:
    exit(etq_error(msg_e_ejecucion(VStp,str(e))))
...
VStp='Paso [4.6]: Se crea la tabla  {} '.format(nme_tbl_otc_t_360_modelo_06(vMainSchema))
#******************************************************************************************************************************************************************************************************************************************************************************************************#
try:
    ts_step = datetime.now()
    print(etq_info(VStp))
    ...
    print(etq_sql(qry_otc_t_360_modelo_06(vTUrmDtacs)))
    df_06=spark.sql(qry_otc_t_360_modelo_06(vTUrmDtacs))
    if df_06.rdd.isEmpty():
        ...
        try:
            ...
            df_06.write.mode('overwrite').saveAsTable(str(nme_tbl_otc_t_360_modelo_06(vMainSchema)))
            df_06.printSchema()
            ...
            exit(etq_error(msg_e_insert_hive(str(nme_tbl_otc_t_360_modelo_06(vMainSchema)),str(e))))
    te_step = datetime.now()
    print(etq_info(msg_d_duracion_ejecucion(VStp,vle_duracion(ts_step,te_step))))
except Exception as e:
    exit(etq_error(msg_e_ejecucion(VStp,str(e))))
...
VStp='Paso [4.7]: Se crea la tabla  {} '.format(nme_tbl_otc_t_360_modelo_07(vMainSchema))
#******************************************************************************************************************************************************************************************************************************************************************************************************#
try:
    ts_step = datetime.now()
    print(etq_info(VStp))
    ...
    try:
        ...
        df_07.write.mode('overwrite').saveAsTable(str(nme_tbl_otc_t_360_modelo_07(vMainSchema)))
        df_07.printSchema()
        ...
        exit(etq_error(msg_e_insert_hive(str(nme_tbl_otc_t_360_modelo_07(vMainSchema)),str(e))))
    te_step = datetime.now()
    print(etq_info(msg_d_duracion_ejecucion(VStp,vle_duracion(ts_step,te_step))))
except Exception as e:
    exit(etq_error(msg_e_ejecucion(VStp,str(e))))
...
VStp='Paso [4.8]: Se crea la tabla  {} '.format(nme_tbl_otc_t_360_modelo_08(vMainSchema))
#******************************************************************************************************************************************************************************************************************************************************************************************************#
try:
    ts_step = datetime.now()
    print(etq_info(VStp))
    ...
    print(etq_sql(qry_otc_t_360_modelo_08(vTUrmDtacs)))
    df_08=spark.sql(qry_otc_t_360_modelo_08(vTUrmDtacs))
    ...
    try:
        ...
        df_08.write.mode('overwrite').saveAsTable(str(nme_tbl_otc_t_360_modelo_08(vMainSchema)))
        df_08.printSchema()
        ...
        exit(etq_error(msg_e_insert_hive(str(nme_tbl_otc_t_360_modelo_08(vMainSchema)),str(e))))
    te_step = datetime.now()
    print(etq_info(msg_d_duracion_ejecucion(VStp,vle_duracion(ts_step,te_step))))
except Exception as e:
    exit(etq_error(msg_e_ejecucion(VStp,str(e))))
...
VStp='Paso [4.9]: Se crea la tabla  {} '.format(nme_tbl_tmp_otc_t_360_modelo_09(vTempSchema))
#******************************************************************************************************************************************************************************************************************************************************************************************************#
try:
    ts_step = datetime.now()
    print(etq_info(VStp))
    ...
    if df_09.rdd.isEmpty():
        ...
        try:
            ...
            df_09.write.mode('overwrite').saveAsTable(str(nme_tbl_tmp_otc_t_360_modelo_09(vTempSchema)))
            df_09.printSchema()
            ...
            exit(etq_error(msg_e_insert_hive(str(nme_tbl_tmp_otc_t_360_modelo_09(vTempSchema)),str(e))))
    te_step = datetime.now()
    print(etq_info(msg_d_duracion_ejecucion(VStp,vle_duracion(ts_step,te_step))))
except Exception as e:
    exit(etq_error(msg_e_ejecucion(VStp,str(e))))
...
VStp='Paso [4.10]: Se crea la tabla  {} '.format(nme_tbl_tmp_otc_t_360_modelo_10(vTempSchema))
#******************************************************************************************************************************************************************************************************************************************************************************************************#
try:
    ts_step = datetime.now()
    print(etq_info(VStp))
    ...
    if df_10.rdd.isEmpty():
        ...
        try:
            ...
            df_10.write.mode('overwrite').saveAsTable(str(nme_tbl_tmp_otc_t_360_modelo_10(vTempSchema)))
            df_10.printSchema()
            ...
            exit(etq_error(msg_e_insert_hive(str(nme_tbl_tmp_otc_t_360_modelo_10(vTempSchema)),str(e))))
    te_step = datetime.now()
    print(etq_info(msg_d_duracion_ejecucion(VStp,vle_duracion(ts_step,te_step))))
except Exception as e:
    exit(etq_error(msg_e_ejecucion(VStp,str(e))))
...
VStp='Paso [4.11]: Se crea la tabla  {} '.format(nme_tbl_tmp_otc_t_360_modelo_11(vTempSchema))
#******************************************************************************************************************************************************************************************************************************************************************************************************#
try:
    ts_step = datetime.now()
    print(etq_info(VStp))
    ...
    if df_11.rdd.isEmpty():
        ...
        try:
            ...
            df_11.write.mode('overwrite').saveAsTable(str(nme_tbl_tmp_otc_t_360_modelo_11(vTempSchema)))
            df_11.printSchema()
            ...
            exit(etq_error(msg_e_insert_hive(str(nme_tbl_tmp_otc_t_360_modelo_11(vTempSchema)),str(e))))
    te_step = datetime.now()
    print(etq_info(msg_d_duracion_ejecucion(VStp,vle_duracion(ts_step,te_step))))
except Exception as e:
    exit(etq_error(msg_e_ejecucion(VStp,str(e))))
...
VStp='Paso [4.12]: Se crea la tabla  {} '.format(nme_tbl_tmp_otc_t_360_modelo_12(vTempSchema))
#******************************************************************************************************************************************************************************************************************************************************************************************************#
try:
    ts_step = datetime.now()
    print(etq_info(VStp))
    ...
    if df_12.rdd.isEmpty():
        ...
        try:
            ...
            df_12.write.mode('overwrite').saveAsTable(str(nme_tbl_tmp_otc_t_360_modelo_12(vTempSchema)))
            df_12.printSchema()
            ...
            exit(etq_error(msg_e_insert_hive(str(nme_tbl_tmp_otc_t_360_modelo_12(vTempSchema)),str(e))))
    te_step = datetime.now()
    print(etq_info(msg_d_duracion_ejecucion(VStp,vle_duracion(ts_step,te_step))))
except Exception as e:
    exit(etq_error(msg_e_ejecucion(VStp,str(e))))
...
try:
    ...
    if df_13.rdd.isEmpty():
        ...
        try:
            ...
            df_13.write.mode('append').insertInto(otc_t_360_modelo)
            df_13.printSchema()
            ...
            exit(etq_error(msg_e_insert_hive(otc_t_360_modelo,str(e))))
    te_step = datetime.now()
    print(etq_info(msg_d_duracion_ejecucion(VStp,vle_duracion(ts_step,te_step))))
except Exception as e:
    exit(etq_error(msg_e_ejecucion(VStp,str(e))))
